...
void Hello::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimArrayPacking(b,this->nodes,8);
}

void Hello::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cPacket::parsimUnpack(b);
    doParsimArrayUnpacking(b,this->nodes,8);
}

unsigned int Hello::getNodesArraySize() const
{
    return 8;
}

int Hello::getNodes(unsigned int k) const
{
    if (k>=8) throw omnetpp::cRuntimeError("Array of size 8 indexed by %lu", (unsigned long)k);
    return this->nodes[k];
}

void Hello::setNodes(unsigned int k, int nodes)
{
    if (k>=8) throw omnetpp::cRuntimeError("Array of size 8 indexed by %lu", (unsigned long)k);
    this->nodes[k] = nodes;
}
...
std::string HelloDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Hello *pp = (Hello *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getNodes(i));
        default: return "";
    }
}
...
bool HelloDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Hello *pp = (Hello *)object; (void)pp;
    switch (field) {
        case 0: pp->setNodes(i,string2long(value)); return true;
